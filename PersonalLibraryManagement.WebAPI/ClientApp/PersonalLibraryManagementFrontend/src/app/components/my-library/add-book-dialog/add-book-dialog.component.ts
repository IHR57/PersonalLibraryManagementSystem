...
export class AddBookDialogComponent {
  ...
  getAllWriterBySearchInput() {
    this.libraryService
      .getAllWriters(this.bookForm.controls['writer'].value)
      .subscribe({
        next: (response: any) => {
  ...
  getAllCategoryBySearchInput() {
    this.libraryService
      .getAllCategory(this.bookForm.controls['category'].value)
      .subscribe({
        next: (response: any) => {
  ...
  addNewBook() {
    ...
    this.libraryService.addNewBook(this.bookForm.value).subscribe({
      next: (response: any) => {
